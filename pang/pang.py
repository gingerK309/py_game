...
def game():
    # 배경음, 효과음
    shoot = pygame.mixer.Sound('./rsc/char.wav')
    hit = pygame.mixer.Sound('./rsc/hit.wav')
    shoot.set_volume(0.3)
    hit.set_volume(0.3)
    pygame.mixer.music.load('./rsc/bgm.ogg')
    pygame.mixer.music.play(-1)

    # 스테이지
    stage = pygame.image.load('./rsc/stage.png')
    stage_size = stage.get_rect().size
    stage_height = stage_size[1]

    # 캐릭터
    char = pygame.image.load('./rsc/char2.png').convert_alpha()
    ...
    # 무기
    weapon = pygame.image.load('./rsc/weapon.png').convert_alpha()
    ...
    # 공
    ball_imgs = [
        pygame.image.load('./rsc/balloon1.png').convert_alpha(),
        pygame.image.load('./rsc/balloon2.png').convert_alpha(),
        pygame.image.load('./rsc/balloon3.png').convert_alpha(),
        pygame.image.load('./rsc/balloon4.png').convert_alpha()
    ]
